        ...
        if pair[0] != "#":
            ...
            for i in range(2):
                if not teams[-1].get(newpair[i][0]):
                    teams[-1][newpair[i][0]]={}#making a new team if there isn't already one
...
def main(n, b, file):
    ...
    timetable, teams=unpack_data(raw_data) #unpacks the text document and puts them into two arrays- timetable and teams
    ...
    #print(teams)
    print("success!")
    return(detriment_X+detriment_Y+detriment_Z)

if __name__ == "__main__":
    n = 12 #number of teams
    b = 10 #number of players
    file = "#1text.txt"
    main(
        n=n,
        b=b,
